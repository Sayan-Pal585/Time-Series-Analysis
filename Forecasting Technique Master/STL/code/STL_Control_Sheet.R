...
home_path  <<- "/Users/aliqureshi/Desktop/TheMathCompany/KM/STL_Module"
setwd(home_path)
...
# source(file="ARIMA_SARIMA_Functions.R")

#Intialize all functions
source(paste(home_path, "Code/STL_Functions.R", sep = "/"))
...
stl.model.results(training_data, 
                  test_data, 
                  trn.period, 
                  tst.period, 
                  freq, 
