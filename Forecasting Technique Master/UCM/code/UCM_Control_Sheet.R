...
home_path  <<- "/Users/aliqureshi/Desktop/TheMathCompany/KM/UCM_Module"
setwd(home_path)
...
#Intialize all functions
source(paste(home_path, "Code/UCM_Functions.R", sep = "/"))
...
ucm.model.results (training_data, 
                  test_data, 
                  trn.period, 
                  tst.period, 
                  freq, 
