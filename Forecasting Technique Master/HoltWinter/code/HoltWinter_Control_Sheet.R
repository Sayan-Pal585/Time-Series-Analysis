...
home_path  <<- "/Users/aliqureshi/Desktop/TheMathCompany/KM/HoltWinter_Module"
setwd(home_path)
...
#Intialize all functions
source(paste(home_path, "Code/HoltWinter_Functions.R", sep = "/"))
...
hw.model.results (training_data, 
                   test_data, 
                   trn.period, 
                   tst.period, 
                   freq, 
...
##------------------------ End of HoltWinters model building-----------------##
