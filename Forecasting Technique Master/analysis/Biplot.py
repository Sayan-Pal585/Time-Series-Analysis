...
def createGraphDependent(df,colX,colY,dependent,event):
...
def createGraphBubble(df2,colX,colY, bubbleGroup=None,bubbleSize=None,bubbleColor=None, timeColumn = None):
